    ...
    return (
        ...
        <>
            <motion.nav
                ...
                className="sticky top-0 container mx-auto flex flex-col items-center justify-between z-50 border-b-1 backdrop-blur-md shadow-md shadow-violet-500 rounded-2xl text-slate-50 "
            >
            <div className="container mx-auto flex items-center justify-between px-6 py-2 h-20">
                ...
                <div className="hidden md:flex">
                    <div className="flex items-center justify-center gap-2 md:gap-8 rounded-full border-x-2 px-20 py-3 shadow-md shadow-violet-600">
                        <Link href="#" className="font-semibold hover:border-b-2 hover:text-sky-600 py-4">Home</Link>
                        <Link href="#" className="font-semibold hover:border-b-2 hover:text-sky-600 py-4">Skills</Link>
                        <Link href="#" className="font-semibold hover:border-b-2 hover:text-sky-600 py-4">Profile</Link>
                    </div>
                </div>
                    {user ? (
