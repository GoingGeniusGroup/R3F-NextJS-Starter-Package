...
export default function Cesium() {
  ...
  return (
    <>
      <div className="absolute size-96 bg-black"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto sapiente laboriosam quod veniam praesentium, natus voluptas eos, quis explicabo culpa iure dolor earum asperiores nostrum unde suscipit autem excepturi inventore?</p></div>
